...
public class Teste extends JPanel {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(masterScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 979, Short.MAX_VALUE)
                            .addComponent(detailScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 979, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                Teste.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Teste.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                Teste.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Teste.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                Teste.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                Teste.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<renderer.Cliente> toRemove = new ArrayList<renderer.Cliente>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            renderer.Cliente C = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(C);
            entityManager.remove(C);
        }
