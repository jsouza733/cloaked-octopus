...
public class TTT extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                TTT.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                TTT.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                TTT.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                TTT.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                TTT.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                TTT.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        renderer.Cliente C = new renderer.Cliente();
        entityManager.persist(C);
        list.add(C);
        int row = list.size() - 1;
